...
def build_scenario(builder):
  ...
  builder.AddPlayer(-1.000000, 0.000000, e_PlayerRole_GK, controllable=False)
  builder.AddPlayer(-0.04,  0.040000, e_PlayerRole_RM, controllable=False)
  builder.AddPlayer(-0.04, -0.040000, e_PlayerRole_CF, controllable=False)
  builder.AddPlayer(-0.1, -0.1, e_PlayerRole_LB, controllable=False)
  builder.AddPlayer(-0.1,  0.1, e_PlayerRole_CB, controllable=False)
